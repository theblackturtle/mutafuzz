...
public class AddToTargetAction implements RequestTableAction<RequestObject> {
   ...
   *
   * <p>This worker processes each RequestObject sequentially, creating HttpRequestResponse objects
   * and adding them to Burp's site map. Progress updates show the current URL being processed.
   *
