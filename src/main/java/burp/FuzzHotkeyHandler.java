...
/**
 * Handles hotkey shortcuts for quick fuzzer creation. Extracts selected text from HTTP requests and
 * replaces it with a placeholder for parameter substitution.
 */
