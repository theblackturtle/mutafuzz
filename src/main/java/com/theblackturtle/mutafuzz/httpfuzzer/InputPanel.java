...
public class InputPanel extends JTabbedPane {
  ...
  private void initializeTabs() {
    ...
    // Directory tab
    directoryTreePanel =
        new DirectoryTreePanel(defaultDirectoryPath, basePreferenceKey + SUFFIX_DIRECTORY_TREE);
    ...
    addChangeListener(
        e -> {
          ...
          if (selectedIndex >= 0) {
            PreferenceUtils.setIntPreference(preferenceKeyLastTab, selectedIndex);
    ...
    int lastSelectedTab =
        PreferenceUtils.getIntPreference(preferenceKeyLastTab, PAYLOADS_TAB_INDEX);
