...
/**
 * Displays non-cancellable progress feedback during fuzzer shutdown operations. Shows fuzzer name
 * and indeterminate progress bar while background disposal completes.
 */
