...
/**
 * Displays and tracks frequently used files in a sortable table. Maintains usage counters and
 * persists selection state across sessions for quick access to common payloads.
 */
public class MostUsedPanel extends JXPanel {
  ...
  public MostUsedPanel(String preferenceKey, PreferenceManager preferenceManager) {
    this.model = new MostUsedTableModel(preferenceKey, preferenceManager);
