...
/**
 * Clipboard operations for table actions. Provides utilities for copying text and lists to the
 * system clipboard.
 */
public final class ClipboardUtils {
  ...
  /**
   * Copies multiple lines to the system clipboard. Lines are separated by newlines (\n).
   *
