package com.theblackturtle.mutafuzz.util.common;

import java.text.DecimalFormat;
import java.util.Random;

/**
 * String manipulation, random data generation, and formatting utilities. Extracted from the old
 * Utils.java.
 */
public final class StringUtils {
  ...
  /**
   * Counts the number of lines in a string. Handles LF, CR, and CRLF line endings.
   *
  ...
  /**
   * Counts the number of words in a string. Words are sequences of letters or digits separated by
  ...
  /**
   * Generates a random alphanumeric string. First character is always a letter (g-z) to ensure
