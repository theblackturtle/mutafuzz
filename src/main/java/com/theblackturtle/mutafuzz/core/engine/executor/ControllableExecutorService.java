...
public interface ControllableExecutorService extends ExecutorService {
  ...
  /**
   * Pauses executor by blocking new task execution. Active tasks continue running. Queued tasks
   * remain intact for resume().
   */
  void pause();
  ...
  /**
   * Registers a listener to be notified when executor terminates. Listeners are invoked after all
   * tasks complete and executor shuts down.
   *
